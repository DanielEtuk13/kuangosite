					...
					<div class="col-12 col-md-10 d-none d-lg-block">
						<nav class="site-navigation position-relative text-right" role="navigation">
							<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
								...
								<li><a href="/kuangosite/pricing.php" class="nav-link">Pricing</a></li>
								<li class="active">
				...
				<div id="shopping-cart" class="container">
					<div class="row justify-content-center text-center">
						<div class="col-md-7">
							...
							<a id="btnEmpty" href="pricing.php?action=empty">Empty Cart</a>
							<?php
						...
						<div id="product-grid">
							...
							?>
									<div class="product-item">
										<form method="post" action="pricing.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
											<div class="product-image"><img src="<?php echo $product_array[$key]["image"]; ?>"></div>
											<div class="product-tile-footer">
												<div class="product-title"><?php echo $product_array[$key]["name"]; ?></div>
												<div class="product-price"><?php echo "N" . $product_array[$key]["price"]; ?></div>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-md-5 text-center text-md-right">
							<p>
								<a href="/kuangosite/pricing.php" class="btn"><span class="icofont-dollar mr-3"></span>Pricing Page</a>
							</p>
						</div>
					</div>
				</div>
						...
						<div class="row site-section pt-0">
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<ul class="list-unstyled">
									<li><a href="/kuangosite/pricing.php">Pricing</a></li>
							...
							<div class="col-md-4 mb-4 mb-md-0">
								<h3>Purchase</h3>
								<ul class="list-unstyled">
									<li><a href="/kuangosite/pricing.php">Purcahse online </a></li>
									<li>
