...
<head>
  ...
  <!-- Favicons -->
  <link href="img/kuango_logo.jpg" rel="icon" />
  <link href="img/kuango_logo.jpg" rel="apple-touch-icon" />
        ...
        <div class="row align-items-center">
          <div class="col-6 col-lg-2">
            <h1 class="mb-0 site-logo">
              <a href="index.html" class="mb-0">KuangoQMS</a>
            </h1>
          </div>
            ...
            <form action="payment.php" method="post" role="form" class="php-email-form">
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <textarea class="form-control" name="address" cols="30" rows="10" data-rule="required" data-msg="Please write an address"></textarea>
                  <div class="validate"></div>
                </div>
